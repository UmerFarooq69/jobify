<x-form>
    <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-8 px-6 mt-3">
        @foreach ($jobs as $job)
        <div class="w-full">
            <div class="bg-gradient-to-r from-blue-900 to-blue-100 text-white py-6 px-8 rounded-2xl shadow-xl transition-all transform hover:scale-105 hover:shadow-2xl hover:bg-teal-600 w-full">
