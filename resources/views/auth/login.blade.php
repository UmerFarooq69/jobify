<x-form>
    <div class="min-h-screen flex items-center justify-center bg-gray-100 px-4 md:px-6 py-12">
        <div class="bg-white shadow-2xl rounded-3xl overflow-hidden max-w-4xl w-full grid grid-cols-1 md:grid-cols-2 relative">
            
            <!-- Login Form Section -->
            <div class="p-6 sm:p-8 md:p-10 flex flex-col justify-center transition-all duration-500">
                <h2 class="text-2xl sm:text-3xl md:text-4xl font-extrabold text-gray-900 mb-4 text-center" id="form-title">
                    Welcome Back
                </h2>
            ...
            <div class="hidden md:flex items-center justify-center bg-gradient-to-r from-blue-900 to-blue-300 text-white p-10">
                <div class="text-center max-w-xs">
                    <h2 class="text-2xl font-bold">Join Us</h2>
                    <p class="text-white/80 mt-4 text-sm">Contact us today to register your business and enjoy seamless access to our platform.</p>
                    <a href="/contact" class="inline-block mt-6 bg-white text-blue-500 px-6 py-3 rounded-full font-semibold shadow-lg hover:bg-gray-100 transition">
                        Contact Us
                    </a>
                </div>
            </div>
