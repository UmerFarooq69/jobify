    ...
    <div class="flex items-center justify-between flex-wrap">
        ...
        <div class="flex flex-col items-center space-y-4 w-full sm:w-auto text-center sm:text-left">
            <div class="flex flex-row space-x-2 items-center justify-center w-full">
                ...
                <button
                    class="w-10 h-10 bg-blue-600 text-white text-lg cursor-pointer flex justify-center items-center rounded-full hover:bg-blue-700 transition duration-300"
...
<div id="jobDescriptionModal-{{ $job->id }}"
    ...
    <div
        class="bg-gradient-to-br from-white to-gray-100 p-10 rounded-2xl shadow-2xl w-full max-w-4xl h-auto max-h-[90vh] overflow-y-auto transform transition-transform duration-300 scale-95">
        <div class="flex justify-between items-center mb-6">
            <h2 class="text-3xl font-bold text-gray-900">📌 Job Description</h2>
            <button class="text-gray-600 hover:text-red-500 transition-all duration-300 text-3xl font-bold"
                data-close="jobDescriptionModal-{{ $job->id }}">&times;</button>
        </div>
