<x-admin>
    ...
    @if($applications->isEmpty())
        <div class="flex flex-col items-center justify-center p-16 bg-white border border-gray-200 rounded-xl">
            ...
            <p class="text-base font-semibold text-gray-700">No applications yet</p>
            <p class="text-sm text-gray-400 mt-1">Select a company or check back later</p>
        </div>
    @else
        <div class="space-y-3">
            @foreach ($applications as $application)
                ...
                <div class="bg-white border border-gray-200 rounded-xl p-5 flex flex-col sm:flex-row sm:items-center justify-between gap-4">
                    <div class="space-y-1">
                        ...
                        <div class="inline-flex items-center gap-1 text-xs text-gray-600 bg-gray-100 px-2 py-0.5 rounded-full mt-1">
