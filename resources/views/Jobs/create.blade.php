<x-form>
    <div class="min-h-screen flex items-center justify-center bg-gradient-to-r from-blue-900 to-blue-100 px-6">
        <div class="bg-white shadow-2xl rounded-3xl overflow-hidden max-w-4xl w-full p-8 space-y-6">
            ...
            <form action="{{ route('jobs.store') }}" method="POST" enctype="multipart/form-data" class="space-y-6">
                ...
                <button type="submit"
                    class="w-full bg-blue-500 text-white py-3 rounded-lg hover:bg-blue-600 transition duration-300 focus:outline-none focus:ring-4 focus:ring-blue-400 shadow-md text-lg font-semibold">
                    Post Job
                </button>
            </form>
        </div>
