            ...
            <form action="{{ route('company.update', $company) }}" method="POST" enctype="multipart/form-data">
                ...
                <div>
                    ...
                    <input type="text" id="name" name="name" value="{{$company->name}}" required
                        class="w-full mt-2 px-4 py-3 rounded-lg bg-gray-100 text-gray-900 border border-gray-300 focus:outline-none focus:ring-2 focus:ring-blue-400 focus:border-blue-400 shadow-sm">
                </div>
                ...
                <div>
                    ...
                    <textarea id="description" name="description" {{ old('description', $company->description ?? '') }}
                        rows="4" required
                        class="w-full mt-2 px-4 py-3 rounded-lg bg-gray-100 text-gray-900 border border-gray-300 focus:outline-none focus:ring-2 focus:ring-blue-400 focus:border-blue-400 shadow-sm">{{ old('description', $company->description ?? '') }}</textarea>
                </div>
                ...
                <button type="submit"
                    class="w-full bg-blue-600 text-white py-3 rounded-lg hover:bg-blue-700 transition duration-300 focus:outline-none focus:ring-2 focus:ring-blue-400 shadow-md text-lg font-semibold">
                    Update Company
                </button>
            </form>
        </div>
