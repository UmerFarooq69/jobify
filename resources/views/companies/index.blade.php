<x-form>
    <div class="bg-gradient-to-r from-blue-900 to-blue-100 min-h-48 flex flex-col md:flex-row items-center justify-center pt-3 px-4 md:px-10">
        <img src="{{ asset('storage/img/logo.jpeg') }}" alt="Logo" class="w-full max-w-xs md:max-w-lg mr-0 md:mr-6 mb-4 md:mb-0 object-contain">
