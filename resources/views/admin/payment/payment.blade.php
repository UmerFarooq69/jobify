<x-admin>
    <div class="container mx-auto mt-8">
        ...
        <form method="GET" action="{{ route('payment.index') }}" class="mb-6 flex justify-center">
            ...
            <button type="submit"
                class="bg-gradient-to-r from-blue-900 to-blue-300 text-white px-4 py-2 rounded hover:bg-blue-600">
                Search
            </button>
        </form>
                            ...
                            <td class="px-4 py-2 text-left">
                                @if ($payment->attachment)
                                    <a href="{{ asset('storage/' . $payment->attachment) }}" target="_blank">
                                        <img src="{{ asset('storage/' . $payment->attachment) }}" alt="Payment Image"
